                    ...
                    <div class="row row-sm text-center">
                        <div class="col-xs-6">
                            <div class="panel padder-v item">
                                <div class="h1 text-info font-thin h1">${monExpressage_number}</div>
                                <span class="text-muted text-xs">本月快递</span>
                        ...
                        <div class="col-xs-6">
                            <div class="panel padder-v item bg-info">
                                <div class="h1 text-fff font-thin h1">${monExpressage_wait_number}</div>
                                <span class="text-muted text-xs">本月待配送快递</span>
                                <div class="top text-right w-full">
                                    <i class="fa fa-caret-down text-warning m-r-sm"></i>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6">
                            <div class="panel padder-v item bg-primary">
                                <div class="h1 text-fff font-thin h1">${monExpressage_compelete_number}</div>
                                <span class="text-muted text-xs">本月已完成快递</span>
                                <div class="top text-right w-full">
                                    <i class="fa fa-caret-down text-warning m-r-sm"></i>
                                </div>
                            </div>
            ...
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <div class="small m-b-xs">
                        <span class="text-muted"><i class="fa fa-clock-o"></i>${news.create_time}</span>
                    </div>
                    <p style="display: -webkit-box;-webkit-box-orient: vertical;-webkit-line-clamp: 2;overflow: hidden">
                        ${news.aviation_news_info}
                    </p>
                </div>
                </c:forEach>
            </div>
...
<!-- Flot -->
<script src="<%=basePath%>/aviation/js/plugins/flot/jquery.flot.js"></script>
<script src="<%=basePath%>/aviation/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
<script src="<%=basePath%>/aviation/js/plugins/flot/jquery.flot.resize.js"></script>
<script src="<%=basePath%>/aviation/js/plugins/flot/jquery.flot.pie.js"></script>
<!-- 自定义js -->
<script src="<%=basePath%>/aviation/js/content.js"></script>
<!--flotdemo-->
